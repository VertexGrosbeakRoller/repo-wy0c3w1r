...
import tech.javelin.base.events.impl.input.EventSetScreen;
import tech.javelin.base.events.impl.other.EventWindowResize;
import tech.javelin.base.events.impl.player.EventUpdate;
import tech.javelin.base.events.impl.render.EventHudRender;
import tech.javelin.client.hud.elements.component.InformationComponent;
import tech.javelin.client.hud.elements.component.KeybindsComponent;
...
import tech.javelin.utility.render.display.Render2DUtil;
import tech.javelin.utility.render.display.base.CustomDrawContext;
import tech.javelin.utility.render.display.base.GuiUtil;
...
public final class Interface extends Module {
   ...
   private final NumberSetting backgroundAlpha = new NumberSetting("Прозрачность фона", 240.0F, 0.0F, 255.0F, 1.0F);
   private final NumberSetting blurStrength = new NumberSetting("Сила блюра", 18.0F, 0.0F, 50.0F, 1.0F);
   ...
   public float getBackgroundAlpha() {
      return this.backgroundAlpha.getCurrent();
   }

   public float getBlurStrength() {
      return this.blurStrength.getCurrent();
   }
   ...
   private Interface() {
      ...
      Javelin.getInstance().getNotifyManager().setNotifyComponent(notifyComponent);
      ...
      // this.addElement(new CooldownsComponent("Cooldowns", 349.0F, 100.0F, 960.0F, 495.5F, -122.0F, 140.0F, DraggableHudElement.Align.TOP_RIGHT));
      ...
      // this.addElement(new MusicHudComponent("MusicHud", 0.0F, 0.0F, 960.0F, 495.5F, 10.0F, 240.0F, DraggableHudElement.Align.TOP_LEFT));
   }
   ...
   public void onRender(EventHudRender event) {
      // Проверяем UnHook - блокируем рендер HUD если активен
      if (tech.javelin.client.modules.impl.misc.UnHook.INSTANCE.shouldHideHud()) {
         return;
      }
